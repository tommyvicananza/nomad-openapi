...
can be found in this repository at [v1/openapi.yaml](https://github.com/tommyvicananza/nomad-openapi/blob/main/v1/openapi.yaml).
...
```shell
$ go get github.com/tommyvicananza/nomad-openapi
```
...
import (
	...
	v1 "github.com/tommyvicananza/nomad-openapi/v1"
)
...
The [README](https://github.com/tommyvicananza/nomad-openapi/blob/main/generator/README.md)
...
- [ ] Make the appropriate changes.
  ...
  - [ ] If you are adding new endpoints, start by copying this snippet: [./snippets/generator-endpoint.txt](https://github.com/tommyvicananza/nomad-openapi/blob/main/snippets/generator-endpoint.txt). Write the new endpoint by hand in the generator snippet. Refer to the slideshow above.
